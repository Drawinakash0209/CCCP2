    ...
    <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white">
        ...
        <div class="h-full ml-14 mt-14 mb-10 md:ml-64 px-4">
            <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6 mt-10">
                ...
                <!-- Add Batch Form -->
                <div class="mb-6">
                    <form action="BatchServlet" method="post" enctype="application/x-www-form-urlencoded" class="w-full">
                ...
                <div class="flex justify-end mb-6">
                    <form action="BatchServlet" method="post" class="w-full md:w-1/3">
                        <input type="hidden" name="action" value="searchBatch">
                        <input type="text" id="product_id" name="product_id" placeholder="Enter Product ID..." class="w-full px-4 py-2 rounded-md border border-gray-300 bg-white dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" required>
