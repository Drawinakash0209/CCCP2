...
<body class="bg-gray-100">
    ...
    <nav class="flex flex-wrap items-center justify-between p-3 bg-[#e8e8e5]">
        <div class="text-xl font-bold">Bappa Flour Mill</div>
        ...
        <div class="toggle hidden w-full md:w-auto md:flex text-right text-bold mt-5 md:mt-0 md:border-none">
            <a href="#dashboard" class="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none">Dashboard</a>
            <a href="onlineShop?action=viewProducts" class="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none">Shop</a>
            <a href="viewOrders" class="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none">Orders</a>
            <a href="#contactUs" class="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none">Contact</a>
    ...
    <section class="py-10" id="actions">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <a href="onlineShop?action=viewProducts" class="mt-4 inline-block px-4 py-2 bg-[#c8a876] text-white rounded hover:bg-[#c09858]">Wec
                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <img src="https://images.unsplash.com/photo-1516321165247-7b6b0e1e8831?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Logout" class="w-full h-64 object-cover">
                    <div class="p-6 text-center">
                        <h3 class="text-xl font-medium text-gray-800 mb-2">Logout</h3>
                        <p class="text-gray-700 text-base">Sign out of your account securely.</p>
                        <a href="logout" class="mt-4 inline-block px-4 py-2 bg-[#c8a876] text-white rounded hover:bg-[#c09858]">Logout</a>
                    </div>
                </div>
            </div>
        </div>
